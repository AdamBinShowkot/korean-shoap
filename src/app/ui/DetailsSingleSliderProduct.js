...
import './DetailsSingleSliderProduct.scss';
import ConfigureAxios from '@/utils/axiosConfig';
import CartModal from '../shared/CartModal';
import ProductsTitle from './ProductsTitle';
import axios from 'axios';

const DetailsSingleSliderProduct=({data,IsFromProductsPage,IsFromHomePage})=>{
...
export default DetailsSingleSliderProduct;