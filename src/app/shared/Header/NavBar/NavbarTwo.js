...
const NavBarTwo=()=>{
    return(
        <>
            <ul class="exo-menu">
                <li><a class="active" href="#"><i className="fa fa-home"></i> Home</a></li>
                <li className="drop-down"><a href="#"><i className="fa fa-cogs"></i> Flyout</a>
                    <ul className="drop-down-ul animated fadeIn">
                    <li className="flyout-right"><a href="#">Flyout Right</a>
                    ...
                    <li className="flyout-left"><a href="#">Flyout Left</a>
                        <ul className="animated fadeIn">
                            <li><a href="#">Mobile</a></li>
                            <li><a href="#">Computer</a></li>
                            <li><a href="#">Watch</a></li>
                ...
                <li><a href="#"><i className="fa fa-cogs"></i> Services</a></li>
