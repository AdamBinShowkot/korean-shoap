            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        height="30" 
                        fill="currentColor" 
                        class="bi bi-house-door-fill footer-icon" 
                        viewBox="0 0 16 16">
                    ...
                    height="30" 
                    fill="currentColor" 
                    className="bi bi-list footer-icon" 
                    viewBox="0 0 16 16"
                    onClick={()=>{
                    ...
                    >
                        ...
                        height="28" 
                        fill="currentColor" 
                        className="bi bi-heart footer-icon" 
                        viewBox="0 0 16 16">
                    ...
                    >
                        ...
                        height="30" 
                        fill="currentColor" 
                        className="bi bi-cart footer-icon" 
                        viewBox="0 0 16 16"
                        >
                  ...
                  >
                    ...
                    height="30" 
                    fill="currentColor" 
                    className="bi bi-person footer-icon" 
                    viewBox="0 0 16 16">
